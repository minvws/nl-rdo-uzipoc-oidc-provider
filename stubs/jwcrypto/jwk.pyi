...
class JWK(dict):
    ...
    def export(self, private_key: bool = ..., as_dict: bool = ...): ...
    def export_public(self, as_dict: bool = ...): ...
    def export_private(self, as_dict: bool = ...): ...
    def export_symmetric(self, as_dict: bool = ...): ...
    def public(self): ...
    @property
    def has_public(self): ...
    @property
    ...
    def get_op_key(self, operation: Incomplete | None = ..., arg: Incomplete | None = ...): ...
    def import_from_pyca(self, key) -> None: ...
    def import_from_pem(self, data, password: Incomplete | None = ..., kid: Incomplete | None = ...) -> None: ...
    def export_to_pem(self, private_key: bool = ..., password: bool = ...): ...
    @classmethod
    def from_pyca(cls, key): ...
    @classmethod
    def from_pem(cls, data, password: Incomplete | None = ...): ...
...
class JWKSet(dict):
    ...
    def setdefault(self, key, default: Incomplete | None = ...): ...
    def add(self, elem) -> None: ...
    def export(self, private_keys: bool = ..., as_dict: bool = ...): ...
