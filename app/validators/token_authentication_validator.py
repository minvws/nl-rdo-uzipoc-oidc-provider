...
class TokenAuthenticationValidator:
    ...
    def validate_client_authentication(
        ...
        if (
            ...
            raise HTTPException(status_code=500, detail="invalid client_authentication")
        ...
        if client_assertion_jwt is None or client_assertion_type is None:
            raise HTTPException(
                status_code=400, detail="Invalid client authentication request"
            )
        ...
        if client_assertion_type != CLIENT_ASSERTION_TYPE:
            ...
            raise HTTPException(status_code=400, detail="Invalid client assertion type")
        ...
        try:
            ...
            raise HTTPException(
                status_code=401, detail="Client assertion failed, invalid JWT"
            ) from exception
